...
public class Purchaser : MonoBehaviour, IStoreListener
{
   ...
   ///     builder.AddProduct(kProductIDNonConsumable, ProductType.NonConsumable);
    ...
    public string LocalPrice(int index)
    {
        string price;
        price = m_StoreController.products.WithID(iapItems[index].productID).metadata.localizedPriceString;
        if (price == null)
        {
            price = "$ " + iapItems[index].price;
        }
        else
        {
            iapItems[index].price = float.Parse(price);
        }
        return price;
    }
